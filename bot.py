...
language_markup = InlineKeyboardMarkup([
    ...
    for text, code in LANGUAGE_OPTIONS.items()
])

# Кнопки тем на двух языках
topic_keyboard_ru = [
...
# Шаг: обработка пользовательского ввода
